...
public class MainDriver {
	...
	public void findWebCourse() throws InterruptedException, IOException {
		...
		String path = System.getProperty("user.dir") + "\\screenshot\\web_developmentt.png";
	...
	public void getWebCourseDetails() throws InterruptedException {
		...
		for(int i=1;i<=2;i++) {
			String cname = driver.findElement(By.xpath("/html[1]/body[1]/div[3]/div[1]/div[1]/main[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[2]/div[1]/div[1]/ul[1]/li["+i+"]/div[1]/div[1]/a[1]/div[1]/div[2]/div[1]/h2[1]")).getText();
			//old format
			...
			String rate = driver.findElement(By.xpath("//body[1]/div[3]/div[1]/div[1]/main[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[2]/div[1]/div[1]/ul[1]/li["+i+"]/div[1]/div[1]/a[1]/div[1]/div[2]/div[2]/div[1]/p[1]")).getText();
			String dur = driver.findElement(By.xpath("//*[@id=\"main\"]/div/div/div/div/div/div/div/div/div[2]/div[2]/div/div/ul/li["+i+"]/div/div/a/div/div[2]/div[2]/p")).getText();
			String[] arr = dur.split(" · ");
			System.out.println("Course Name: "+cname+"\nRatings: "+rate+"\nDuration: "+arr[arr.length-1]);
			System.out.println();
			extent.actionInfo("Printing details of "+cname);
			//changeWindow(parent,i);
		}
	...
	public void changeWindow(String parent,int i) {
